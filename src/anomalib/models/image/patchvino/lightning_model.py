...
from .torch_model import PatchvinoModel

logger = logging.getLogger(__name__)


class Patchvino(MemoryBankMixin, AnomalyModule):
    ...
    def __init__(
        ...
        self.model: PatchvinoModel = PatchvinoModel(
            dino_name=backbone,
            pre_trained=pre_trained,
            layers=layers,
            num_neighbors=num_neighbors,input_size=224
        )
    ...
    def configure_transforms(self, image_size: tuple[int, int] | None = None) -> Transform:
        ...
        return Compose(
            [
                Resize(self.smaller_edge_size, antialias=True),
